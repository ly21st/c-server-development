...
libfuse3_la_DEPENDENCIES =
am__libfuse3_la_SOURCES_DIST = fuse.c fuse_i.h fuse_loop.c \
	fuse_loop_mt.c fuse_lowlevel.c fuse_misc.h fuse_opt.c \
	fuse_signals.c buffer.c cuse_lowlevel.c helper.c \
	modules/subdir.c modules/iconv.c mount.c mount_util.c \
	mount_util.h mount_bsd.c
am__dirstamp = $(am__leading_dot)dirstamp
@ICONV_TRUE@am__objects_1 = modules/iconv.lo
@BSD_FALSE@am__objects_2 = mount.lo mount_util.lo
@BSD_TRUE@am__objects_2 = mount_bsd.lo
am_libfuse3_la_OBJECTS = fuse.lo fuse_loop.lo fuse_loop_mt.lo \
	fuse_lowlevel.lo fuse_opt.lo fuse_signals.lo buffer.lo \
	cuse_lowlevel.lo helper.lo modules/subdir.lo $(am__objects_1) \
	$(am__objects_2)
libfuse3_la_OBJECTS = $(am_libfuse3_la_OBJECTS)
AM_V_lt = $(am__v_lt_@AM_V@)
am__v_lt_ = $(am__v_lt_@AM_DEFAULT_V@)
am__v_lt_0 = --silent
am__v_lt_1 = 
libfuse3_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(libfuse3_la_LDFLAGS) $(LDFLAGS) -o $@
...
am__v_CCLD_1 = 
SOURCES = $(libfuse3_la_SOURCES)
DIST_SOURCES = $(am__libfuse3_la_SOURCES_DIST)
...
@NETBSD_TRUE@libfuse3_la_LIBADD = -lperfuse -lpuffs
...
modules/$(DEPDIR)/$(am__dirstamp):
	...
	@: > modules/$(DEPDIR)/$(am__dirstamp)
modules/subdir.lo: modules/$(am__dirstamp) \
	modules/$(DEPDIR)/$(am__dirstamp)
modules/iconv.lo: modules/$(am__dirstamp) \
	modules/$(DEPDIR)/$(am__dirstamp)

libfuse3.la: $(libfuse3_la_OBJECTS) $(libfuse3_la_DEPENDENCIES) $(EXTRA_libfuse3_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libfuse3_la_LINK) -rpath $(libdir) $(libfuse3_la_OBJECTS) $(libfuse3_la_LIBADD) $(LIBS)
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/cuse_lowlevel.Plo@am__quote@
...
@AMDEP_TRUE@@am__include@ @am__quote@modules/$(DEPDIR)/iconv.Plo@am__quote@
@AMDEP_TRUE@@am__include@ @am__quote@modules/$(DEPDIR)/subdir.Plo@am__quote@
